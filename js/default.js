...
function qodeNumberOfTestimonialsItemsResize(){
    ...
    var testimonialsSlider = $j('.testimonials_carousel');
...
function initHashClick(){
    ...
    var paspartuScrollAdd = $j('body').hasClass('paspartu_on_top_fixed') ? $window_width*paspartu_width : 0;
    var scrollToAmount;
    $j(document).on( "click", ".main_menu a, .vertical_menu a, .qbutton:not(.contact_form_button,.ivo), .anchor, .widget li.anchor a", function(){
        var $this = $j(this);
